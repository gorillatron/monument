...
Sails.load({
  ...
  request.get('http://api.soundcloud.com/users/monument-podcast/tracks?client_id=84f2b368d96bdc044dafced637dbce4b&format=json&_status_code_map[302]=200&limit=999999')
    .then(JSON.parse)
    .then((tracks) => {
